package org.frameworkset.datatran.imp.jobhandler;
/**
...
import org.frameworkset.tran.schedule.xxjob.AbstractXXLJobFlowHandler;
 ...
 * @Date 2025/6/17
 */
public class XXLJobFlowHandlerDemo extends AbstractXXLJobFlowHandler {
    private static Logger logger = LoggerFactory.getLogger(XXLJobFlowHandlerDemo.class);
